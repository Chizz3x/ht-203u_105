...
public class VerticalRangeSeekBar extends RangeSeekBar {
    ...
    @Override // com.hti.xtherm.seekbar.RangeSeekBar, android.view.View
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode == MeasureSpec.EXACTLY) {
            iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size, MeasureSpec.EXACTLY);
        } else if (mode == Integer.MIN_VALUE && (getParent() instanceof ViewGroup) && size == -1) {
            iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(((ViewGroup) getParent()).getMeasuredHeight(), MeasureSpec.AT_MOST);
        } else {
            if (getGravity() == 2) {
            ...
            iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(rawHeight, MeasureSpec.EXACTLY);
        }
    ...
    @Override // com.hti.xtherm.seekbar.RangeSeekBar
    /*
    ...
    */
    protected void onDrawTickMark(android.graphics.Canvas r13, android.graphics.Paint r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hti.xtherm.seekbar.VerticalRangeSeekBar.onDrawTickMark(android.graphics.Canvas, android.graphics.Paint):void");
    }
